  ...
  const motorcycles: Motorcycle[] = [
    {
      ...
      year: 2024,
      price: 85000,
      image: "public/IMG/MOTO-MISAKI-GN-150.JPEG",
      condition: "Nueva",
      engine: "321cc",
      featured: true,
    ...
    },
    {
      ...
      year: 2023,
      price: 120000,
      image: "public/IMG/FALCON-200CC.jpeg",
      condition: "Nueva",
      engine: "649cc",
    ...
    },
    {
      ...
      year: 2022,
      price: 65000,
      image: "public/IMG/MOTO-TANK-200.jpeg",
      condition: "Usada",
      engine: "399cc",
      mileage: 8500,
    ...
    },
    {
      ...
      year: 2024,
      price: 95000,
      image: "public/IMG/MOTO-XMT-250.jpeg",
      condition: "Nueva",
      engine: "313cc",
      featured: true,
    ...
    },
    {
      ...
      year: 2021,
      price: 180000,
      image: "public/IMG/Scooter-electrico(1).jpeg",
      condition: "Usada",
      engine: "821cc",
      mileage: 12000,
    ...
    },
    {
      ...
      year: 2023,
      price: 78000,
      image: "public/IMG/TITAN-250.jpeg",
      condition: "Nueva",
      engine: "373cc",
    ...
    },
    {
      ...
      year: 2021,
      price: 180000,
      image: "public/IMG/FLASH 50cc.jpeg",
      condition: "Usada",
      engine: "821cc",
      mileage: 12000,
    ...
    },
    {
      ...
      year: 2021,
      price: 180000,
      image: "public/IMG/ELECTRIC SCOOTER.jpeg",
      condition: "Usada",
      engine: "821cc",
      mileage: 12000,
    ...
    },
    {
      ...
      year: 2024,
      price: 85000,
      image: "public/IMG/MOTO-MISAKI-GN-150-(3).JPEG",
      condition: "Usada",
      engine: "321cc",
      featured: true,
      description: "La MISAKI GN 150 es perfecta para principiantes y riders experimentados. Con su motor de 321cc, ofrece la potencia ideal para la ciudad y carretera.",
