...
const Contact: React.FC<ContactProps> = ({ onPhoneCall, onWhatsApp, onEmail }) => {
  ...
  const contactInfo = [
    { icon: MapPin, title: 'Dirección', content: '297 Northwest 54th Street, Miami, FL 33127' },
    { icon: Phone, title: 'Teléfono', content: '+1(786)2530995' },
    { icon: Mail, title: 'Email', content: 'onewaymotors2@gmail.com' },
    {
      icon: Clock,
      title: 'Horarios',
    ...
    <section id="contacto" className="py-20 bg-black">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Contact Info */}
          <div>
            <h3 className="text-3xl font-black text-white mb-8">Información de Contacto</h3>
            ...
            <div className="bg-red-600/90 backdrop-blur-md border border-red-600/50 rounded-lg p-8 text-center shadow-2xl">
              ...
              <h4 className="text-xl font-black text-white mb-2">Visítanos en Nuestra Tienda</h4>
          ...
          {/* Contact Form */}
          <div>
            <h3 className="text-3xl font-black text-white mb-8">Envíanos un Mensaje</h3>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-lg font-bold text-white mb-2">Nombre *</label>
                  <input
                    type="text"
                    name="firstName"
                ...
                <div>
                  <label className="block text-lg font-bold text-white mb-2">Apellido *</label>
                  <input
                    type="text"
                    name="lastName"
              ...
              <div>
                <label className="block text-lg font-bold text-white mb-2">Teléfono * (solo números)</label>
                <input
                  type="tel"
                  name="phone"
              ...
              <div>
                <label className="block text-lg font-bold text-white mb-2">Motivo de Contacto</label>
                <select
                  name="reason"
            ...
            <div className="mt-8 p-4 bg-red-600/90 backdrop-blur-md border border-red-600/50 rounded-lg shadow-lg">
              <p className="text-lg text-white font-bold">
                <strong>Respuesta rápida:</strong> Nos comprometemos a responder todos los mensajes en menos de 24 horas durante días hábiles.
              </p>
            </div>
          </div>
        </div>
